...
Provide a Supabase-compatible developer surface.

Make migration from Supabase low-friction.

Run each customer project as its own PostgreSQL/MaluDB database on an existing shared MaluDB node.

Add MaluDB-specific memory/database capabilities without breaking Supabase compatibility.
